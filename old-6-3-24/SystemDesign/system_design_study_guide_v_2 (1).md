...
- [System Design Study Guide (v2)](#system-design-study-guide-v2)
  ...
  - [One-A-Day Micro Prompts](#one-a-day-micro-prompts)
...
## One-A-Day Micro Prompts

> Choose one. Think on it for 5–10 minutes. That’s enough.

- 🔁 What’s the difference between Redis and Memcached?
- 📦 Walk through how a GitHub Action builds and deploys your app.
- 🛰️ Explain the role of RabbitMQ in your architecture.
- 🌍 How does GeoIP-based routing work with NGINX?
- 🔐 What’s the safest way to store secrets in GitOps?
- 📡 How would you collect and route sensor data over LoRa?
- 📈 What’s one metric you’d alert on in Prometheus and why?
- ⚙️ How do Helm charts help manage config across environments?
- 🧠 What’s one time you used a queue to improve system resilience?
