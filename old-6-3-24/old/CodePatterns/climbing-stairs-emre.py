...
# Let’s try to populate our dp[] array in a bottom-up fashion. As we see
# from the recursion stack visualization, each climbStairs(n) call is the
# sum of the two previous calls.
...
# Memory Optimization
# As we can see from the visualization of the recursive stack and other
# solutions, to be able to calculate the n, you need the value of last two
