...
if __name__ == "__main__":
    ...
    assert (
        actual == expected
    ), f"Test Case 5 Failed: Input: {nums}, Expected: {expected}, Actual: {actual}"
    ...
    assert (
        actual == expected
    ), f"Test Case 6 Failed: Input: {nums}, Expected: {expected}, Actual: {actual}"
    ...
    assert (
        actual == expected
    ), f"Test Case 7 Failed: Input: {nums}, Expected: {expected}, Actual: {actual}"
